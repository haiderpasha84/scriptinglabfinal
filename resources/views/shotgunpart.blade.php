...
<div class="container">
            <img src="images/q2.png" style="height: 500px; width: 1110px;">
          </div>
...
<div class="container-fluid section-1 bg-gray mb-5">
      ...
      <div class="card bg-dark text-white">
        ...
        <div class="view overlay">
          <img class="card-img-top" src="images/q3.jpg" alt="Card image cap" style="height: 305px;">
          <a>
        ...
        <div class="card-body">
          ...
          <hr>
          <!-- Text -->
          <p class="card-text">Magpul XTM Hand Stop Kit</p>
      ...
      <div class="card bg-dark text-white">
        <!-- Card image -->
        <div class="view overlay">
          <img class="card-img-top" src="images/q4.jpg" alt="Card image cap" style="height: 280px;">
          <a>
            <div class="mask rgba-white-slight"></div>
          </a>
        </div>
        ...
        <div class="card-body">
          ...
          <hr>
          <!-- Text -->
          <p class="card-text">Remington 870 Magazine Extension Kit 12 Ga 18 Barreled Adds 2 Shots Parkerized</p>
          <center>  <button class="btn btnchange btn-rounded btn-md">BUY</button></center>
      ...
      <div class="card bg-dark text-white">
        <!-- Card image -->
        <div class="view overlay">
          <img class="card-img-top" src="images/q5.jpg" alt="Card image cap" style="height: 280px;">
          <a>
            <div class="mask rgba-white-slight"></div>
          </a>
        </div>
        ...
        <div class="card-body">
          ...
          <hr>
          <!-- Text -->
          <p class="card-text">Blackhawk! Knoxx Specops Genii Adjustable Stock And Forend Black Finish Mossberg</p>
          <center>  <button class="btn btnchange btn-rounded btn-md">BUY</button></center>
...
<div class="container-fluid section-1 bg-gray mb-5">
      ...
      <div class="card bg-dark text-white">
        <!-- Card image -->
        <div class="view overlay">
          <img class="card-img-top" src="images/q6.jpeg" alt="Card image cap" style="height: 305px;">
          <a>
            <div class="mask rgba-white-slight"></div>
          </a>
        </div>
        ...
        <div class="card-body">
          ...
          <hr>
          <!-- Text -->
          <p class="card-text">Magpul SGA Sling Mount Mossberg 500/590</p>
          <center>   <button class="btn btnchange btn-rounded btn-md">BUY</button></center>
      ...
      <div class="card bg-dark text-white">
        <!-- Card image -->
        <div class="view overlay">
          <img class="card-img-top" src="images/q7.jpg" alt="Card image cap" style="height: 305px;">
          <a>
            <div class="mask rgba-white-slight"></div>
          </a>
        </div>
        ...
        <div class="card-body">
          ...
          <hr>
          <!-- Text -->
          <p class="card-text">TacStar Sidesaddle Carrier 6rd Mossberg 500/590</p>
          <center>   <button class="btn btnchange btn-rounded btn-md">BUY</button></center>
      ...
      <div class="card bg-dark text-white">
        <!-- Card image -->
        <div class="view overlay">
          <img class="card-img-top" src="images/q8.jpg" alt="Card image cap" style="height: 305px;">
          <a>
            <div class="mask rgba-white-slight"></div>
          </a>
        </div>
        ...
        <div class="card-body">
          ...
          <hr>
          <!-- Text -->
          <p class="card-text">TacStar Benelli Nova, Super Nova Extension 7 Shot</p>
          <center>   <button class="btn btnchange btn-rounded btn-md">BUY</button></center>
...
<div class="container-fluid section-1 bg-gray mb-5">
      ...
      <div class="card bg-dark text-white">
        <!-- Card image -->
        <div class="view overlay">
          <img class="card-img-top" src="images/q9.jpg" alt="Card image cap" style="height: 305px;">
          <a>
            <div class="mask rgba-white-slight"></div>
          </a>
        </div>
        ...
        <div class="card-body">
          ...
          <hr>
          <!-- Text -->
          <p class="card-text">Advanced Shotgun Forend Pistol Grip Synthetic Black</p>
          <center>   <button class="btn btnchange btn-rounded btn-md">BUY</button></center>
      ...
      <div class="card bg-dark text-white">
        <!-- Card image -->
        <div class="view overlay">
          <img class="card-img-top" src="images/q10.jpg" alt="Card image cap" style="height: 305px;">
          <a>
            <div class="mask rgba-white-slight"></div>
          </a>
        </div>
        ...
        <div class="card-body">
          ...
          <!-- Title -->
          <h4 class="card-title">$119</h4>
          <hr>
          <!-- Text -->
          <p class="card-text">Aim Sports M-LOK Rail Remington 870 6061-T6 Aluminum 24.9"</p>
          <center>  <button class="btn btnchange btn-rounded btn-md">BUY</button></center>
      ...
      <div class="card bg-dark text-white">
        <!-- Card image -->
        <div class="view overlay">
          <img class="card-img-top" src="images/q11.jpeg" alt="Card image cap" style="height: 305px;">
          <a>
            <div class="mask rgba-white-slight"></div>
          </a>
        </div>
        ...
        <div class="card-body">
          ...
          <hr>
          <!-- Text -->
          <p class="card-text">Beretta 12 Ga Choke Tube Wrench With Thread Chaser</p>
          <center>  <button class="btn btnchange btn-rounded btn-md">BUY</button></center>
